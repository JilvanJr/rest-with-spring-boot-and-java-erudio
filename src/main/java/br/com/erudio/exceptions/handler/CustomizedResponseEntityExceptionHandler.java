...
// @ControllerAdvice > Concentra algum tratamento que seja espalhado em todas controllers
@ControllerAdvice
@RestController
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {

    // Retorna a exceção customizada
    // @ExceptionHandler > Qual o tipo de exception vai encaixar neste tratamento
